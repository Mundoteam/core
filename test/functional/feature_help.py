...
"""Verify that starting mundoteam with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start mundoteam with -h for help text")
        ...
        self.log.info("Start mundoteam with -version for version information")
        ...
        self.log.info("Start mundoteamd with -fakearg to make sure it does not start")
